...
extern const string cusz_short_doc =
    ...
    "\n"
    "usage: cusz [-zxrhV] [-i file] [-f32|64] [-m mode] [-e eb] [-1|2|3 ...] ...\n"
    "\n"
    "  z : zip/compress\n"
    "  x : unzip/decompress\n"
    "  r : dryrun\n"
    ...
    "\n"
    "  i file  : specify input datum\n"
    "  f 32|64 : specify float or double type\n"
    ...
    "  D name  : specify demo dataset, skip interpretation\n"
    "              (1D) hacc1g  hacc4g  (2D) cesm  exafeldemo\n"
    "              (3D) hurricane  nyx  qmc  qmcpre  aramco  parihaka\n"
    "  d num   : specify codebook size\n"
    "\n"
    "example:\n"
    "    zip: ./bin/cusz -f32 -m r2r -e 1e-4 -i ./data/sample-cesm-CLDHGH -D cesm -z\n"
    "    zip: ./bin/cusz -f32 -m r2r -e 1e-4 -i ./data/sample-cesm-CLDHGH -2 3600 1800 -z\n"
    "  unzip: ./bin/cusz -i ./data/sample-cesm-CLDHGH -x\n"
    "\n"
    "\"cusz -h\" for details.\n";
